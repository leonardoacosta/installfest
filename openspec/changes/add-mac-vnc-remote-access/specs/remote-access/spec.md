...
## Purpose
Cross-machine screen/desktop remote-access tooling for the ssh-mesh (Mac, homelab, cloudpc),
managed declaratively via chezmoi and layered on top of the existing Tailscale-only mesh trust
boundary rather than introducing a new tunnel.
