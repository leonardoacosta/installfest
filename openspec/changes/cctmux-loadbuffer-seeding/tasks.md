...
- [ ] [1.1] Add a `load_buffer`/`paste_buffer` (and `delete_buffer`) helper to
...
- [ ] [1.2] Replace both seeding sites in `apps/cc-tmux/src/cc_tmux/conductor.py`
  ...
  - depends on: 1.1
  - [type:security]
- [ ] [1.3] Add the newline-strip guard as belt-and-suspenders defense-in-depth: if
...
- [ ] [2.1] Add a `test_prompt_seeding_*` self-test to `apps/cc-tmux/src/cc_tmux/testing.py`
...
- [ ] [2.2] Run `cd apps/cc-tmux && cc-tmux self-test` — all pass, including the new
