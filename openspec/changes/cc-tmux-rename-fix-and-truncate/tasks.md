...
- [ ] [1.1] [P-1] `apps/cc-tmux/src/cc_tmux/cli.py`: bump `_TAB_NAME_MAX` from `10` to `20`.
  [owner:general-purpose] [type:api] [beads:if-93wo]
- [ ] [1.2] [P-1] `apps/cc-tmux/src/cc_tmux/cli.py` (`_maybe_rename_window`): capture the result
...
- [ ] [1.3] [P-1] `apps/cc-tmux/src/cc_tmux/cli.py` (`_trace_register`): add a `rename_succeeded`
...
- [ ] [1.4] [P-2] `openspec/specs/cc-tmux/spec.md`: apply this proposal's MODIFIED Requirement
...
- [ ] [2.2] [P-1] Live verification: after deploying, tail `cc-tmux-register-trace.log` during a
